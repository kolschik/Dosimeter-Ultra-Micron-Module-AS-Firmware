...
var
  ...
  spectra_massive: array[0..4096] of UInt32;
  ...
  spectra_massive_ready: array[0..8640] of boolean;
...
begin
  ...
  begin
   ...
   SetLength(vAns, 1);
   vAns[0]:=$04; // выполнить сброс счетчиков дозиметра
   RS232.Send(vAns);
  end;
end;
end;
