          ...
          begin
            ...
            begin
              ...
              begin
                ...
                AssignFile(Fx, 'Spectr_'+mainFrm.Spectro_time.Text+'.csv'); // связали файл с переменной
                ...
                CloseFile(Fx);
                ShowMessage('Сбор спектра завершен! файл Spectr_'+mainFrm.Spectro_time.Text+'.csv сохранен ');
              end;
